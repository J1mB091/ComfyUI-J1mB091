...
function wanResolutionSelectorHandler(node) {
  if (node.comfyClass !== "WanResolutionSelector") return;
...
app.registerExtension({
  name: "J1mB091.WanResolutionSelector.showcontrol",
  nodeCreated(node) {
    if (node.comfyClass !== "WanResolutionSelector") return;

    // Initial apply
    wanResolutionSelectorHandler(node);
